...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Enter any topic to get an animated video explanation with scenes and transitions.',
    shortDescription: 'Create animated explainer videos from any topic',
    category: 'writing',
    icon: 'Video',
    color: 'rose',
    apiEndpoint: '/api/tools/explainer',
    credits: 3,
    features: ['Animated scenes', 'Multiple styles', 'Auto-generated', 'Browser playback'],
    status: 'active',
  },
  {
    id: 'assignment-worker',
    slug: 'assignment-worker',
    name: 'Assignment Worker',
    description: 'Give any assignment and AI will autonomously complete all tasks — essays, math, code, research, analysis, and more.',
    shortDescription: 'AI completes your entire assignment autonomously',
    category: 'writing',
    icon: 'BrainCircuit',
    color: 'blue',
    apiEndpoint: '/api/tools/assignment-worker',
    credits: 5,
    features: ['Multi-task support', 'Agentic workflow', 'Code execution', 'Rich output'],
    status: 'active',
  },
  {
    id: 'devils-advocate',
