...
const toolMapping: Record<string, { slug: string; name: string; category: string }> = {
  ...
  "video-explainer": { slug: "video-explainer", name: "Video Explainer", category: "writing" },
  "assignment-worker": { slug: "assignment-worker", name: "Assignment Worker", category: "writing" },
