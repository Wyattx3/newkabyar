...
const plans = [
  ...
  },
  {
    ...
    price: "9",
    period: "/mo",
    desc: "Everything you need to excel in studies",
    icon: Rocket,
    color: "blue",
  ...
  },
  {
    ...
    price: "19",
    period: "/mo",
    desc: "For power users who want unlimited access",
    icon: Crown,
    color: "gray",
    cta: "Get Pro Plan",
    ...
    features: [
      "All 25+ tools",
      "Unlimited credits",
      "All AI models (GPT-4, Claude, Gemini, Grok)",
...
const faqs = [
  {
    q: "What are credits?",
    a: "Credits are used each time you use a tool. Different tools cost different amounts of credits. Simple tools like paraphrasing cost 1-2 credits, while complex tools like Video Explainer cost 5-10 credits.",
  },
  {
  ...
  },
  {
    ...
    a: "Our Student plan at $9/mo is already our most affordable option designed specifically for students. We also offer annual billing with 2 months free.",
  },
  {
    q: "Which AI models are included?",
    a: "Free plan includes basic models. Student plan adds GPT-4 and Claude. Pro plan includes all models: GPT-4, Claude, Gemini, and Grok.",
  },
  {
    q: "Do unused credits roll over?",
    a: "Credits reset each billing cycle and do not roll over. Pro plan has unlimited credits so this doesn't apply.",
  },
  {
